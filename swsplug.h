...
public:
    ...
    swsPlug *connectedFrom() const { return mConnectedFrom; }
    const std::unordered_set<swsPlug *>& connectedTo() const { return mConnectedTo; };
    ...
    std::unordered_set<swsPlug *> listConnectable();
